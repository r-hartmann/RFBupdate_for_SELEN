!
!
! This is program "TB-utilities.F90" 
!
! *** Adapted by RH March 2018 - Extracted TABOO code from original tb.F90 
!                                to allow multiple usage of TABOO for the 
!                                rotational feedback analysis. 
!                                This tb-utilities.F90 computes the LOVE NUMBERS
!                                for any correct task_1.dat and hence is usable
!                                for LOADING or TIDAL analysis.
!
! +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
