...
!             !NEW! ROTATIONAL  FEEDBACK !NEW!
! ========================================================
! ###### Rotational feedback option ######
!
  IF(line(1:3)=='131') THEN 
	call scan_string (line, 1, ss, nout)
	option_rfb=ss(1) 
	if(option_rfb=='y')Write(88,*) "The ROTATIONAL FEEDBACK will be included in the SLE" 
	if(option_rfb=='n')Write(88,*) "The ROTATIONAL FEEDBACK will NOT be included in the SLE"
  ENDIF
! ========================================================
! ========================================================
!
...
If    (ice_file=='ice3g.dat'    .or.ice_file=='ice3g_and.dat'.or.& 
       ...
       ice_file=='ice3g_gre.dat'.or.ice_file=='ice3g_ice.dat'.or.&  
...
ELSEIF(ice_file=='ice1.dat'    .or.ice_file=='ice1_eup.dat'.or. & 
       ice_file=='ice1_gre.dat'.or.ice_file=='ice1_nam.dat')    then 
!
...
!             !NEW! ROTATIONAL  FEEDBACK !NEW!
! ========================================================
If(mode=='1') Write(2,*) "echo '     Mode: 1 (fully self-gravitating)'"
If(mode=='2') Write(2,*) "echo '     Mode: 2 (elastic approximation)'"
If(mode=='3') Write(2,*) "echo '     Mode: 3 (eustatic approximation)'"
If(mode=='4') Write(2,*) "echo '     Mode: 4 (Woodward approximation)'"
If(mode=='5') Write(2,*) "echo '     Mode: 5 (ice load neglected)'"
If(option_rfb=='y') then 
    Write(2,*) " echo  '     Rotational Feedback: ON'" 
Else
    Write(2,*) " echo  '     Rotational Feedback: OFF'" 
Endif
! ========================================================
! ========================================================
!
...
!             !NEW! ROTATIONAL  FEEDBACK !NEW!
! ========================================================
Write(2,*) "mkdir ",depot//"/Love-Numbers-by-TABOO/tides/"
! ========================================================
! ========================================================
...
!
Write(2,*) ' t1=$(date +%s.%N)'
Write(2,*) ' echo "     [elapsed time: "$(echo "$t1 - $t0" | bc)" s]"'
Write(2,*) ' t0=$t1'
!
! ========================================================
...
!
        if(option_gmt=='y') then
          Write(2,*) ' t1=$(date +%s.%N)'
          Write(2,*) ' echo "     [elapsed time (plotting): "$(echo "$t1 - $t0" | bc)" s]"'
          Write(2,*) ' t0=$t1'
        endif
!
Endif
...
!	Write(2,*) "mv ss.dat ", depot//"/Love-Numbers-by-TABOO/"
	Write(2,*) "cp ss.dat ", depot//"/Love-Numbers-by-TABOO/" !
! ========================================================
! ========================================================
...
!	Write(2,*) "mv kk.dat ", depot//"/Love-Numbers-by-TABOO/"
	Write(2,*) "cp kk.dat ", depot//"/Love-Numbers-by-TABOO/"
! ========================================================
! ========================================================
...
Write(2,*) "#echo  ---------------------------------------------------------------------" 
Write(2,*) "echo " 
Write(2,*) " echo  '---> RFBTB.F90: TIDAL-deformation coefficients by TABOO (Normal Modes)'"
Write(2,*) "#echo  ---------------------------------------------------------------------"  
Write(2,*) "rfbtb.exe"         
Write(2,*) "echo " 
If(option_rfb=='y') then 
...
!
    Write(2,*) "/bin/rm -f visco.tmp"
!
    Write(2,*) "cp ", trim(adjustl(visco_file)), " ", depot//"/Love-Numbers-by-TABOO/tides/"  
    Write(2,*) "cp task_1.dat ", depot//"/log/task_tides.dat"
    Write(2,*) "mv task_1.dat ", depot//"/TABOO/task_tides.dat"
    if(mode=='1' .or. mode=='5') then
        Write(2,*) "cp lambda_roots.log ", depot//"/log/lambda_roots.log"
        Write(2,*) "mv lambda_roots.log ", depot//"/TABOO/lambda_roots.log"
    endif
    Write(2,*) "mv spectrum.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
    Write(2,*) "mv ih.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
    Write(2,*) "mv ik.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
    Write(2,*) "mv il.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
    Write(2,*) "mv h.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
    Write(2,*) "mv l.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
    Write(2,*) "mv k.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
!
    If(option_ln=='y') then 
        Write(2,*) "mv ss.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
        Write(2,*) "rm -f ihh.dat "
        Write(2,*) "rm -f ikk.dat "
        Write(2,*) "rm -f ill.dat "
        Write(2,*) "rm -f hh.dat "
        Write(2,*) "rm -f kk.dat "
        Write(2,*) "rm -f ll.dat "
    Endif
...
!
		...
		if(option_gmt=='y') then
		Write(2,*) "mv pal_rslc.cpt", " "//depot//"/rsl/rsl-contours/"	
!
        Write(2,*) ' t1=$(date +%s.%N)'
        Write(2,*) ' echo "     [elapsed time: "$(echo "$t1 - $t0" | bc)" s]"'
        Write(2,*) ' t0=$t1'
...
!
        ...
        if(option_gmt=='y') then
		  ...
		  Write(2,*) "ps2pdf sdotmap.ps"
		  Write(2,*) "ps2pdf udotmap.ps"
		  Write(2,*) "ps2pdf ndotmap.ps"		
		  Write(2,*) "mv sdotmap.ps ", depot//"/gmaps/"
		  Write(2,*) "mv udotmap.ps ", depot//"/gmaps/"
		  Write(2,*) "mv ndotmap.ps ", depot//"/gmaps/"
		  Write(2,*) "mv sdotmap.pdf ", depot//"/gmaps/"
		  Write(2,*) "mv udotmap.pdf ", depot//"/gmaps/"
		  Write(2,*) "mv ndotmap.pdf ", depot//"/gmaps/"
!
          Write(2,*) ' t1=$(date +%s.%N)'
          Write(2,*) ' echo "     [elapsed time: "$(echo "$t1 - $t0" | bc)" s]"'
          Write(2,*) ' t0=$t1'
...
! ========================================================
	If(option_rfb=='y') then 
        Write(2,*) "mv ebur.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
        Write(2,*) "mv ebvr.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
        Write(2,*) "mv ebsr.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
        Write(2,*) "mv ebnr.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
        Write(2,*) "mv rfb.dat ", depot//"/Love-Numbers-by-TABOO/tides/"
    Endif
! ========================================================
! ========================================================
elseif(option_pw=='y')then  
...
Write(2,*) ' t1=$(date +%s.%N)'
Write(2,*) "echo ''"
Write(2,*) ' echo " >>> Total runtime: "$(echo "$t1 - $tstart" | bc)" s"'
Write(2,*) "echo ''"
! --- Closing "selen.sh"
   close(2)
!
...
!             !NEW! ROTATIONAL  FEEDBACK !NEW!
! ========================================================
Write(3,*) "! --- Rotational feedback"
Write(3,*) "CHARACTER, PARAMETER :: RFB_OPT='"//trim(adjustl(option_rfb))//"'"
! ========================================================
! ========================================================
If(option_topo=='y') then
 CONTINUE
...
!
  Write(9,*) "gmt gmtset PS_MEDIA A4"
  Write(9,*) "gmt gmtset FONT_LABEL 26p"
...
! - Plotting a string with "power" of the interpolating line
  Write(9,*) "gmt pstext -O dv-power.tmp -N -JX -R -G255 -W1,0 >> ", trim(adjustl(psfilename)) 
!
!
! - Cleaning 
...
!	
  open(9,file=file_gmt,status='unknown')
  Write(9,*) "gmt gmtset PS_MEDIA A4"
  Write(9,*) "gmt gmtset FONT_LABEL 24p"
!  Write(9,*) "gmt gmtset ANOT_FONT_SIZE 10p"
  Write(9,*) "gmt gmtset MAP_FRAME_WIDTH 0.15c"
  Write(9,*) " "
!
!
!
...
!
	   ...
	   close(4)	   	   
!
 	   Write(9,*) "gmt pstext rslc1.tmp -N -JM -R -G255 -O -K >> rslc-map.ps" 
 	   Write(9,*) "gmt pstext rslc2.tmp -N -JM -R -G255 -W1,0 -O >> rslc-map.ps" 
...
!
	...
	REAL*8, PARAMETER :: MAP_FRAME_WIDTH = 2. 
!
!
!
...
! --- Adds a frame to avoid border effects using GMT  
	lon_min=lon_min - MAP_FRAME_WIDTH 
	lon_max=lon_max + MAP_FRAME_WIDTH 
	lat_min=lat_min - MAP_FRAME_WIDTH
	lat_max=lat_max + MAP_FRAME_WIDTH
!
! NEW code as of November 2009 
	i_lon_max=aint((lon_max-lon_min)/lon_lat_inc) + 1
	i_lat_max=aint((lat_max-lat_min)/lon_lat_inc) + 1
...
! --- Draw thick and thin lines 
	    if(ninc=='30') then 
	      awkstring="'{print 30.-$1, $2}'"
	elseif(ninc=='26') then 
	      awkstring="'{print 26.-$1, $2}'"
	elseif(ninc=='21') then 
	      awkstring="'{print 21.-$1, $2}'"
	elseif(ninc=='18') then 
	      awkstring="'{print 18.-$1, $2}'"
	elseif(ninc=='1')  then 
	      awkstring="'{print 1.-$1, $2}'"
    elseif(ninc=='40') then 
          awkstring="'{print (40.-$1)*0.050125, $2}'"
    else 
          awkstring=""
          Write(*,*) "WARNING: awkstring is empty!"
    endif
!	
	Write(9,*) "awk "//trim(adjustl(awkstring))//" esl-thin.dat > esl.tmp"	
	Write(9,*) "gmt psxy esl.tmp -B -R -JX -W2,0 -O -K >> plot.ps"
!
	Write(9,*) "awk "//trim(adjustl(awkstring))//" esl.dat > esl.tmp"	
	Write(9,*) "gmt psxy esl.tmp -B -R -JX -W6,0 -O -K >> plot.ps"
!
...
! --- Target fiel for GMT script 
	 ...
	 Write(19,*) "gmt gmtset PS_MEDIA A4" 
	 Write(19,*) "gmt gmtset FONT_TITLE 24p"
	 Write(19,*) "gmt gmtset MAP_FRAME_WIDTH 0.1c"
	 Write(19,*) " "
!
! --- -R and -B options 
...
! --- A note about the average rate, in the bottom frame
	...
	Write(19,*) "gmt pstext -N tmpctitle5", " -G255 -JX -R -O >> plot.ps" 	
...
!
	Write(29,*) "gmt gmtset PS_MEDIA A4" 
	Write(29,*) "gmt gmtset FONT_TITLE 24p"
	Write(29,*) "gmt gmtset MAP_FRAME_WIDTH 0.1c"
...
! --- Frame with all data 
	...
	Write(29,*) "gmt pstext -N titleall.tmp -G255 -JM -R -O -K>> map-tgauges.ps"
	Write(29,*) ""
!
! --- Title for all frames 
	...
	Write(29,*) "gmt pstext -N titletgauges.tmp -G255 -JM -R -O -K >> map-tgauges.ps"
	Write(29,*) ""
!
! --- Frame with data with age >= 30 yrs  
	...
	open(18,file='titlege30.tmp',status='unknown') 
 	...
 	Write(29,*) "gmt pstext -N titlege30.tmp -G255 -JM -R -O -K >> map-tgauges.ps"
	Write(29,*) ""
!
! --- Frame with data with age >= 60 yrs  
	...
	open(18,file='titlege60.tmp',status='unknown') 
 	...
 	Write(29,*) "gmt pstext -N titlege60.tmp -G255 -JM -R  -O -K >> map-tgauges.ps"
	Write(29,*) ""
!
! --- Frame with data with age >= 90 yrs 
	...
	Write(29,*) "gmt pstext -N titlege90.tmp -G255 -JM -R -O >> map-tgauges.ps"
!
	close(29) 	
!	
...
!
  ...
  Write(us,*)"gmt gmtset PS_MEDIA A4"
  Write(us,*)"gmt gmtset FONT_LABEL 24p"
!  Write(us,*)"gmt gmtset ANOT_FONT_SIZE 16p" 
  Write(us,*)"gmt gmtset MAP_FRAME_WIDTH 0.1c"
  Write(us,*)" " 
!
  do 100 u=12, 14 
! 
...
!
  ...
  Write(us,*)"gmt pscoast -R -JJ -Di -B -W2/0 -A1000 -O -K >> ", & 
              trim(adjustl(ps_file))
  Write(us,*)"gmt pstext -N -R -JJ -B -G255 -O -K ", trim(adjustl(tmp_file)), " >> ", & 
              trim(adjustl(ps_file))
  Write(us,*)"gmt psscale -U/0.5/0.5/'SELEN 2.9' ", "-C"//trim(adjustl(table_name)), &
...
!
  ...
  Write(us,*)"gmt pstext -N -R -JJ -B -G255 -O -K ", trim(adjustl(tmp_file)), " >> ", & 
              trim(adjustl(ps_file))
  if(u==12.or.u==13) &   
  Write(us,*)"gmt psscale -U/0.5/13/'SELEN 2.9' ", "-C"//trim(adjustl(table_name)), &
...
!
  ...
  Write(us,*)"gmt pscoast -R -JE -Di -Ba30f30g30 -W2/255/0/0 -A0 -O -K >> ", & 
              trim(adjustl(ps_file))
  if(u==12.or.u==13) &   
  Write(us,*)"gmt psscale -X-6 -Y-7 ", "-C"//trim(adjustl(table_name)), &
  ...
  Write(us,*)"gmt psscale -X-6 -Y-7 ", "-C"//trim(adjustl(table_name)), &
              ...
              trim(adjustl(ps_file))
  Write(us,*)"gmt pstext -X6 -N -R -JE -G255 -O -U/4/20.5/'SELEN 2.9' ", trim(adjustl(tmp_file)), " >> ", & 
              trim(adjustl(ps_file))	      	      	      	      
  Write(us,*)" "
!
  700 Continue 
...
!
 ...
 Write(9,*)"gmt gmtset FONT_LABEL 24p"
! Write(9,*)"gmt gmtset ANOT_FONT_SIZE 16p"
 Write(9,*)"gmt gmtset MAP_FRAME_WIDTH 0.1c"
...
Endif
If(option_rof=='z')& 
Write(9,*) "gmt psxy -R -Jm ", trim(adjustl(filecap)), " -W4/0 -B -A -O -K >> ", trim(adjustl(nameout))  
!
...
Write(9,*) "gmt pstext -N -R -Jm -B ", trim(adjustl(NAMEF)), " -G255 -O -K >> ", trim(adjustl(nameout)) 
Write(9,*) "gmt psscale -U/0.5/0.5/'SELEN 2.9' -Cpale.cpt -Bf0.25a0.5/:mm/yr: ", &
...
!
 ...
 Write(9,*) "gmt pstext tmpp4.dat -N -JX -R -G255 -O -K >> wnw.ps"	     
...
Write(9,*) "gmt gmtset PS_MEDIA A4"
!Write(9,*) "gmt gmtset ANOT_FONT_SIZE 16p"
Write(9,*) "gmt gmtset FONT_LABEL 18p"
Write(9,*) "#"
!
...
Write(9,*) "gmt pstext tmpg1.dat -N -JX -R -G255 -O -K >> ela-flu.ps"
!
...
Write(9,*) "gmt pstext tmpg2.dat -N -JX -R -G255 -O -K >> ela-flu.ps"
!
...
Write(9,*) "gmt pstext -N -JX -R -G255 -O -K tmpg6.dat >> spectrum.ps"
Write(9,*) "awk '{print $1, $5}' ss.dat > spe.tmp" 
Write(9,*) "gmt psxy -h7 spe.tmp -B -R -JX -Sc0.15 -G0 -O >> spectrum.ps" 
!
Write(9,*) "#"
...
Write(9,*) "gmt psxy -h2 ihh.dat -B -R -JX -Ss0.25 -W4 -G0   -O -K >> n-residues.ps" 
open (4,file='tmpg7.dat',status='unknown') 
Write(4,*) "1.3 2e0 20 0 0 BL (h)"; close(4) 
Write(9,*) "gmt pstext -N tmpg7.dat -JX -R -G255 -O -K >> n-residues.ps"
Write(9,*) "#"
...
!
 	...
 	Write(19,*) " gmt psxy rslzones-"//label(i)//".dat", " -h -B -R -JX -W0.05/0 -O -K >> plot.ps"
	Write(19,*) " gmt psxy rslzones-"//label(i)//"-ave.dat", " -h -B -R -JX ", W_OPTION(I), " -O -K >> plot.ps"	
!
! --- first sphere 
...
!	Write(19,*) " gmt gmtset ANOT_FONT_SIZE 12p"
	Write(19,*) " gmt gmtset FONT_LABEL 18p"
	Write(19,*) " " 
!Write(19,*) & 
...
!
    Write(19,*) " gmt psbasemap -X3 -Y14 -Ba2f1:'time (ka)':/a50f50Wsen:'RSL (m)':  ", &
 	...
 	Write(19,*) " gmt psxy rslzones-"//label(1)//".dat", " -h -B -R -JX -Sc0.01 -G0/0/255 -O -K >> plot.ps"	
	Write(19,*) " gmt psxy rslzones-"//label(1)//"-ave.dat", " -h -B -R -JX ", W_OPTION(1), " -O -K >> plot.ps"
...
!
 	...
 	Write(19,*) " gmt psxy rslzones-"//label(2)//".dat", " -h -B -R -JX -Sc0.01 -G107/199/231 -O -K >> plot.ps"
	Write(19,*) " gmt psxy rslzones-"//label(2)//"-ave.dat", " -h -B -R -JX ", W_OPTION(2), " -O -K >> plot.ps"
...
!
 	...
 	Write(19,*) " gmt psxy rslzones-"//label(3)//".dat", " -h -B -R -JX -Sc0.01 -G226/0/122 -O -K >> plot.ps"
	Write(19,*) " gmt psxy rslzones-"//label(3)//"-ave.dat", " -h -B -R -JX ", W_OPTION(3), " -O -K >> plot.ps"
...
!
 	...
 	Write(19,*) " gmt psxy rslzones-"//label(4)//".dat", " -h -B -R -JX -Sc0.01 -G105/62/142  -O -K  >> plot.ps"
	Write(19,*) " gmt psxy rslzones-"//label(4)//"-ave.dat", " -h -B -R -JX ", W_OPTION(4), " -O -K  >> plot.ps"
...
!
  	Write(19,*) "gmt psbasemap -X3 -Y3 -U'SELEN 2.9' -JX16/10 -B -G255 -R0/100/0/50 -K > rsl-misfit.ps" 
	Write(19,*) "awk '{print $1, $2}' mis.dat > mis.tmp"
   	Write(19,*) "gmt pshistogram mis.tmp -JX -R -B100a20:misfit:/a10:frequency:WSen -G140 -W2 -O -K >> rsl-misfit.ps" 
...
!
	...
	Write(29,*) "gmt pstext -N tmptitle", " -G255 -O -K -JM -R >> maprsl.ps"
	Write(29,*) ""
!
! ------ Northern emisphere 
!	     	
...
! # Some settings ... 
!
 Write(17,*) "gmt gmtset PS_MEDIA A4"
 Write(17,*) "gmt gmtset FONT_TITLE 24p" 
 Write(17,*) "gmt gmtset MAP_FRAME_WIDTH 0.1c" 
!
!
! ------ 
 C_TABLE="pice.cpt"
...
!
	...
	if(i> 9 .and. i<=99) write(3,'(a1,i2)')  '0',i
	if(i>99) write(3,'(i3)')         i
 	close(3)
...
!
	...
	Write(17,*) "gmt psxy ", trim(adjustl(C_OPTION)), " -A -L ", trim(adjustl(filename)), " -O -K -JM -R >> map.ps" 
	If(option_rof=='r')then
		           Write(17,*) "gmt pscoast -R -JM -Dc  -B -W1/0   -A10000 -O -K >> map.ps" 
		           else
		           Write(17,*) "gmt pscoast -R -JM -Dc  -B -W1/240 -A10000 -O -K >> map.ps" 
	Endif			   
	Write(17,*) "gmt psscale ", trim(adjustl(C_OPTION)), " ", trim(adjustl(B_OPTION)), " -D6/-1/11/1h -O  -K >> map.ps"
!
! ------ Prepares a small title 
!
 	open(8,file='rtmp0'//labchar//'.dat',status='unknown')
	    if(i==0) then 
	             Write(8,'(a18,1x,a5,a18,i2,a4)')    "180 86.5 18 0 1 BC ", & 
	      		   trim(adjustl(titlice)), " thickness until -", nn, " ka "
 	    elseif (1<=i.and.i<=nn)     then	
	             Write(8,'(a18,1x,a5,a12,i2,a6,i2,a4)') "180 86.5 18 0 1 BC ", & 
		   	   trim(adjustl(titlice)), " thickness -", nn-i+1," til -",nn-i, " ka "
	    elseif (i==nn+1 .and. titlice=="myICE")    then
	             Write(8,'(a18,1x,a5,a22)')             "180 86.5 18 0 1 BC ", & 
	                   trim(adjustl(titlice)), " thickness 0 til 1 ka "
	    elseif (i==nn+1 .and. titlice/="myICE")    then
	...
	close(8) 
	Write(17,*) "gmt pstext -N ", "rtmp0"//labchar//".dat", " -O -K -JM -R -G255 >> map.ps"

        if(option_rof=='z')& 
	Write(17,*) "gmt psxy -R -JM ", trim(adjustl(filecap)), " -W1/0 -B -A -O >> map.ps"
!
!
	if(option_rof=='r') then 
!
...
!	     	
	...
	Write(17,*) "gmt psxy ", trim(adjustl(C_OPTION)), " -A -L ", trim(adjustl(filename)), " -O  -K -JG -R >> map.ps"
	If(option_rof=='r')then
...
! # Some settings ... 
!
 Write(1,*) "gmt gmtset PS_MEDIA A4"
 Write(1,*) "gmt gmtset FONT_TITLE 24p" 
 Write(1,*) "gmt gmtset MAP_FRAME_WIDTH 0.1c" 
!
 Write(1,*) ""
!
!
...
!
        if(option_rof=='z')& 
	Write(1,*) "gmt psxy -R -JM ", trim(adjustl(filecap)), " -W1/0 -B -A -O -K >> map.ps"
!        
        Write(1,*) "gmt psscale ", trim(adjustl(C_OPTION)), " ", trim(adjustl(B_OPTION)), & 
	           " -D6/-1/11/1h -O -K >> map.ps"
        Write(1,*) "gmt pstext -N ", " tmp0"//labchar//".dat",  " -JM -R -G255 -O -K >> map.ps"
!
! ------ Prepares a small title 
!
...
!   Write(1,*)"gmt pscontour -I -JQ -R recof.dat -Cpale.cpt -O -K >> of.ps"
   Write(1,*)"gmt psxy -JQ -R recof.dat -Sc0.02 -Cpale.cpt -O -K >> of.ps"
...
!
   ...
   Write(1,*)"gmt psscale -Cpale.cpt -Bf0.1a0.5g0.5/:O.F.: -D8/-2/8/1h -O >> of.ps"
!
 Else
!
! --- "Zonal" OF 
...
!
   ...
   Write(1,*)"gmt psxy -R -JQ ", trim(adjustl(FILECAP)), " -W1/255 -Gblue -L -B -A -O -K >> of.ps"
...
!   Write(1,*)"gmt pscontour -I -JQ -R recof.dat -Cpale.cpt -O -K >> of.ps"
   Write(1,*)"gmt psxy -JQ -R recof.dat -Sc0.02 -Cpale.cpt -O -K >> of.ps"
   Write(1,*)"gmt psxy -R -JQ ", trim(adjustl(FILECAP)), " -W1/255 -B -A -O -K >> of.ps"
...
Write(11,*)"gmt gmtset PS_MEDIA A4" 
Write(11,*)"gmt gmtset FONT_TITLE 24p"
Write(11,*)"gmt gmtset MAP_FRAME_WIDTH 0.1c"
...
" | gmt pstext -N -R -JQ -O -K -G255/0/0 -W1,0 >> px.ps"
!
...
Write(11,'(a27,i3,a4,i6,a1,a59)') "echo '10 -70 14 0 2 LM RES=", nres, ", N=", NP, "'", & 
" | gmt pstext -N -R -JQ -O -G0/0/255 -W1,0 >> px.ps"
!
...
" | gmt pstext -N -R -JQ -O -G255 -W1,0 >> px-sphere.ps"
!
 close(11)
! 
...
! Write(19,*)"gmt gmtset ANOT_FONT_SIZE 16p"
 Write(19,*)"gmt gmtset FONT_LABEL 16p"
!
 r_option = & 
...
!
 Write(9,*) "gmt gmtset PS_MEDIA A4"
! Write(9,*) "gmt gmtset ANOT_FONT_SIZE 16p"
 Write(9,*) "gmt gmtset FONT_LABEL 20p"
 Write(9,*) " "
...
! A title (revised) 
 ...
 close(4) 
 Write(9,*) "gmt pstext title_stokes.tmp -N -JX -R -G255 -O -K >> stokes.ps"
!
...
2 continue 
  close(4) 
 Write(9,*) "gmt pstext stokes0.tmp -JX -R -G255 -O -W220 -K >> stokes.ps" 
!
...
!
 ...
 Write(9,*) "gmt pstext stokes1.tmp -N -JX -R -G255 -O -K >> stokes.ps" 
!
...
! 
 ...
 Write(9,*) "gmt pstext stokes4.tmp -N -JX -R -G255 -O  >> stokes.ps"
!
 CLOSE(9) 
!
